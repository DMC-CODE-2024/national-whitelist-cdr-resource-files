...
INSERT IGNORE INTO sys_param (DESCRIPTION,tag,TYPE,VALUE,ACTIVE,feature_name,remark,user_type,modified_by) VALUES ('NWLOnlineAPICheck for source NWL','NWLOnlineAPICheck',0,'false',1,'National Whitelist','','','');
INSERT IGNORE INTO app.sys_param (description,tag,type,value,active,feature_name,remark,user_type,modified_by) VALUES ('These are the allowed device types.','allowed_device_type',1,'Smartphone , Feature phone',0,'National Whitelist','Valid for National Whitelist CDR and National Whitelist EDR','system','system');
INSERT IGNORE INTO sys_param (DESCRIPTION,tag,TYPE,VALUE,ACTIVE,feature_name,remark,user_type,modified_by) VALUES ('latest date when national whitelist process for unique imei ran','app_nw_unique_imei_last_run_time',0,'',1,'National Whitelist','This tag is valid for National Whitelist CDR','system','system');
INSERT IGNORE INTO sys_param (DESCRIPTION,tag,TYPE,VALUE,ACTIVE,feature_name,remark,user_type,modified_by) VALUES ('latest date when foreign whitelist process for unique imei ran','app_nw_unique_foreign_imei_last_run_time',0,'',1,'National Whitelist','This tag is valid for National Whitelist CDR','system','system');
INSERT IGNORE INTO sys_param (DESCRIPTION,tag,TYPE,VALUE,ACTIVE,feature_name,remark,user_type,modified_by) VALUES ('latest date when foreign whitelist process for imei with different msisdn ran','app_nw_foreign_unique_imei_diff_msisdn_last_run_time',0,'',1,'National Whitelist','This tag is valid for National Whitelist CDR','system','system');
